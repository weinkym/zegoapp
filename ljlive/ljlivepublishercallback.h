#ifndef LJLIVEPUBLISHERCALLBACK_H
#define LJLIVEPUBLISHERCALLBACK_H
...
namespace LIVEROOM
{
class LJLivePublisherCallback : public ILivePublisherCallback
{
public:
    /**
     推流状态更新
     ...
     */
    virtual void OnPublishStateUpdate(int stateCode, const char* pszStreamID, const ZegoPublishingStreamInfo& oStreamInfo);
    ...
    virtual ~LJLivePublisherCallback();
...
#endif // LJLIVEPUBLISHERCALLBACK_H
