#ifndef LJROOMCALLBACK_H
#define LJROOMCALLBACK_H
...
namespace ZEGO
{
    namespace LIVEROOM
    {
        class LJRoomCallback : public IRoomCallback
        {
        public:
            /**
            InitSDK成功回调
            ...
            */
             ...
             */
            virtual void OnLoginRoom(int errorCode, const char *pszRoomID, const ZegoStreamInfo *pStreamInfo, unsigned int streamCount);
             ...
             */
            virtual void OnStreamUpdated(ZegoStreamUpdateType type, ZegoStreamInfo *pStreamInfo, unsigned int streamCount, const char *pszRoomID);
            ...
            /**
             ...
             @param pszRoomID 房间 ID
             */
            virtual void OnStreamExtraInfoUpdated(ZegoStreamInfo *pStreamInfo, unsigned int streamCount, const char *pszRoomID);
            ...
            virtual ~LJRoomCallback() {}
        };

        class LJAVEngineCallback : public IAVEngineCallback
        {
        public:
            /**
             音视频引擎停止时回调
             */
            virtual void OnAVEngineStop();

            virtual ~LJAVEngineCallback();
        };
    }

}

#endif // LJROOMCALLBACK_H
