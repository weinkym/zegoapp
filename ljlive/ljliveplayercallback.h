#ifndef LJLIVEPLAYERCALLBACK_H
#define LJLIVEPLAYERCALLBACK_H
...
namespace ZEGO
{
    namespace LIVEROOM
    {
        class LJLivePlayerCallback : public ILivePlayerCallback
        {
        public:
            /**
             播放状态更新
             ...
             */
            virtual void OnPlayStateUpdate(int stateCode, const char* pszStreamID);
            ...
            virtual ~LJLivePlayerCallback();
        };

        class LJZegoVideoRenderCallback : public IZegoVideoRenderCallback
        {
        public:
            /**
             视频帧数据回调
